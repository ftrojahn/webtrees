...
$user_email2     = Filter::postEmail('user_email2');
...
case 'register':
	...
	if (Session::get('good_to_send') && $user_name && $user_password01 && $user_password01 == $user_password02 && $user_realname && $user_email && $user_email2 && $user_comments) {
	...
	<div id="login-register-page">
		...
		<div id="register-box">
			<form id="register-form" name="register-form" method="post" onsubmit="return checkform(this);" autocomplete="off">
				...
				<div>
					<label for="user_email2">
						<?php echo I18N::translate('Email address'); ?>
						<input type="email" id="user_email2" name="user_email2" required maxlength="64" value="<?php echo Filter::escapeHtml($user_email2); ?>">
					</label>
					<p class="small text-muted">
						<?php echo I18N::translate('This email address will be used to send password reminders, website notifications, and messages from other family members who are registered on the website.'); ?>
					</p>
