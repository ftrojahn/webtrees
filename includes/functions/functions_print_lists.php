...
function format_indi_table($datalist, $option='') {
		...
		->addInlineJavascript('
			...
			var oTable'.$table_id.' = jQuery("#'.$table_id.'").dataTable( {
				...
				columns: [
					...
					/*  9 deat date */ { dataSort: 13 },
					/* 10 DEAT:DATE */ { visible: false },
					/* 11 deat plac */ { type: "unicode" },
					/* 12 CHAN      */ { dataSort: 19, visible: '.($SHOW_LAST_CHANGE?'true':'false').' },
	...
	$html .= '<th>GIVN</th>';
	$html .= '<th>SURN</th>';
	$html .= '<th>'. /* I18N: Abbreviation for “Sosa-Stradonitz number”.  This is an individual’s surname, so may need transliterating into non-latin alphabets. */ WT_I18N::translate('Sosa'). '</th>';
	$html .= '<th>SOSA</th>';
		...
		->addInlineJavascript('
			...
			var oTable'.$table_id.'=jQuery("#'.$table_id.'").dataTable( {
				...
				columns: [
					...
					/*  2 GIVN,SURN */ {type: "unicode", visible: false},
					/*  3 SURN,GIVN */ {type: "unicode", visible: false},
					/*  4 wife givn */ {dataSort: 8},
					/*  5 wife surn */ {dataSort: 9},
					/*  6 GIVN,SURN */ {type: "unicode", visible: false},
					/*  7 SURN,GIVN */ {type: "unicode", visible: false},
					/*  8 marr date */ {dataSort: 13},
					/*  9 MARR:DATE */ {visible: false},
					/* 11 CHAN      */ {dataSort: 19, visible: '.($SHOW_LAST_CHANGE?'true':'false').'},
					/* 12 CHAN_sort */ {visible: false},
					/* 13 MARR      */ {visible: false},
					/* 14 DEAT      */ {visible: false},
					/* 15 TREE      */ {visible: false}
				],
				sorting: [[1, "asc"]],
				displayLength: 20,
				pagingType: "full_numbers"
